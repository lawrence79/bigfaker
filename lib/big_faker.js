...
exports.Name = require('./big_faker/name');
exports.Address = require('./big_faker/address');
exports.PhoneNumber = require('./big_faker/phone_number');
exports.Internet = require('./big_faker/internet');
exports.Company = require('./big_faker/company');
exports.Lorem = require('./big_faker/lorem');
exports.Department = require('./big_faker/department');

var Helpers = exports.Helpers = require('./big_faker/helpers');
...
/**
 * big_faker.addLocale(name, data) -> void
 * - name (string): locale name, for example `en-us`
 * - data (object|string): locale hash or yaml file
 *
 * Load locale to big_faker. big_faker preload some
 * [locales](https://github.com/nodeca/big_faker/tree/master/lib)
 **/
...
/**
 * big_faker.numerify(source) -> string
...
/**
 * big_faker.letterify(source) -> string
 * - source (string): source string
 *
