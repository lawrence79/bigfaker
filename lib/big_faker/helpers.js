...
/**
 * class BigFaker.Helpers
 *
 **/


/**
 * BigFaker.Helpers.rand(max, min = 0) -> Integer
...
/**
 * BigFaker.Helpers.sample(source) -> Mixin
...
/**
 * BigFaker.Helpers.shuffle(source) -> Array
 * - source(array): source array
 *
...
/**
 * BigFaker.Helpers.capitalize(str) -> String
