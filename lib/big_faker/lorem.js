...
/**
 * BigFaker.Lorem.words(wordCount = 3, supplemental = false) -> Array
...
exports.words = function(wordCount, supplemental) {
	...
	var words = BigFaker.translate('lorem.words');

	if ( !! supplemental) {
		words = words.concat(BigFaker.translate('lorem.supplemental'));
	}
...
/**
 * BigFaker.Lorem.sentence(wordCount=null, supplemental=false, capitalize=true) -> String
...
/**
 * BigFaker.Lorem.sentences(sentenceCount, supplemental=false) -> Array
...
/**
 * BigFaker.Lorem.paragraph(sentenceCount) -> String
...
/**
 * BigFaker.Lorem.paragraphs(paragraphCount=3, sentenceCount=null) -> Array
...
/**
 * BigFaker.Lorem.text(paragraphCount, sentenceCount, glue) -> String
 * - paragraphCount(integer): number of paragraphs in output
 * - supplemental (boolean): use additional words
